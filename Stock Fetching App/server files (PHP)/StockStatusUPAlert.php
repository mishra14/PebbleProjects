<?PHP
  ...
  $message = "Hi, \nThis is an automated alert regarding the stock of $company. The prices have changed by $change % since yesterday. It is advisable to sell the stock.\n\nThanks\nStock Pebble App";		//email body
  $sub = "Pebble Alert - sell stock";		//subject for the email
